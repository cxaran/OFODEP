...
import 'package:ofodep/blocs/list_cubits/stores_list_cubit.dart';
...
class _AdminStoresPageState extends State<AdminStoresPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider<StoresListCubit>(
          ...
          builder: (context) => Scaffold(
            body: Column(
              children: [
                ...
                Expanded(
                  child: BlocConsumer<StoresListCubit, ListState>(
                          ...
                          builder: (context, pagingState, fetchNextPage) =>
                            ...
                            builderDelegate:
                              ...
                              noItemsFoundIndicatorBuilder: (context) =>
                                  const Center(child: Text('not_found')),
                            ),
                          ),
                        ),
                      );
