...
import 'package:ofodep/blocs/store_subscription_cubit.dart';
        ...
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                BlocBuilder<StoreSubscriptionCubit,
                    CrudState<StoreSubscriptionModel>>(
                  builder: (context, state) {
                    if (state is CrudLoaded<StoreSubscriptionModel>) {
                      return IconButton(
            ...
            body: BlocConsumer<StoreSubscriptionCubit,
                CrudState<StoreSubscriptionModel>>(
